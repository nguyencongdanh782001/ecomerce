...
import { fetchProduct } from '../redux/productRedux'
        ...
        <Container>
            ...
            <FilterContainer>
                ...
                <Filter>
                    ...
                    <Selected onChange={e => setSort(e.target.value)}>
